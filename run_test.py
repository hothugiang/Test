...
class TestTransportFee(unittest.TestCase):
    ...
    def test_43(self, mock_print, mock_input):
        main()
        mock_print.assert_called_with(75000.0)
